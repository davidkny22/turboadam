...
import pytest
import time
from turboadam.costate import encode_blocks, decode_blocks, decompose, compute_block_ratios, compute_thresholds, classify_blocks
...
class TestTritonCostateEncode:
    ...
    def test_self_roundtrip(self):
        ...
        cos_sim = torch.nn.functional.cosine_similarity(
            m_hat.reshape(1, -1), m_exact.reshape(1, -1),
        ).item()
