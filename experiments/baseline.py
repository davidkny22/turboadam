...
Output: JSONL log at experiments/results/baseline_log.jsonl
"""
...
def parse_args():
    p = argparse.ArgumentParser(description="Baseline AdamW training on GPT-2 124M")
...
def main():
    ...
    log_path = os.path.join(args.output_dir, "baseline_log.jsonl")
